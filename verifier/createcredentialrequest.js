let credentialschema = ["Student ID Credential","Graduation Credential"];
let dic = {"Student ID Credential":"StudentIDCredential", "Graduation Credential":"AcademicTranscriptCredential"};
let counter=0;
